...
def ls_menu():
    while True:
        ...
        print('3. Найти номер по фамилии.')
        ...
        if n == 1:
            ...
            change = checking_the_number(input('Введите номер пункта: '))
            ...
            print('2. Найти номер по имени.')
            print('3. Поиск по номеру телефона.')
            deleting = checking_the_number(input('Введите номер пункта: '))
